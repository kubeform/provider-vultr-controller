...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-dns-vultr-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=dns.vultr.kubeform.com,resources=domains,versions=v1alpha1,name=domain.dns.vultr.kubeform.io,sideEffects=None,admissionReviewVersions=v1
