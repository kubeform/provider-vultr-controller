...
import (
	...
	vultrscheme "kubeform.dev/provider-vultr-api/client/clientset/versioned/scheme"
...
func init() {
	_ = vultrscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform vultr Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-vultr-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "vultr.kubeform.com",
			})
			if err != nil {
