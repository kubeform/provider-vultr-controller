...
// +kubebuilder:rbac:groups=dns.vultr.kubeform.com,resources=records,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.vultr.kubeform.com,resources=records/status,verbs=get;update;patch
...
func (r *RecordReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.Record{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.Record{}.APIVersion, dnsv1alpha1.Record{}.Kind)
			return err
		}
	}
