...
// +kubebuilder:rbac:groups=instance.vultr.kubeform.com,resources=instances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=instance.vultr.kubeform.com,resources=instances/status,verbs=get;update;patch
...
func (r *InstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &instancev1alpha1.Instance{}); err != nil {
			klog.Error(err, "unable to set up auditor", instancev1alpha1.Instance{}.APIVersion, instancev1alpha1.Instance{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&instancev1alpha1.Instance{}).
...
func (r *InstanceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Instance")
			return nil
		}
		...
		resourceList := &instancev1alpha1.InstanceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Instance")
			return nil
		}
