...
// Ipv4Reconciler reconciles a Ipv4 object
type Ipv4Reconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=instance.vultr.kubeform.com,resources=ipv4s,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=instance.vultr.kubeform.com,resources=ipv4s/status,verbs=get;update;patch

func (r *Ipv4Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("ipv4", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Ipv4")
...
func (r *Ipv4Reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &instancev1alpha1.Ipv4{}); err != nil {
			klog.Error(err, "unable to set up auditor", instancev1alpha1.Ipv4{}.APIVersion, instancev1alpha1.Ipv4{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&instancev1alpha1.Ipv4{}).
