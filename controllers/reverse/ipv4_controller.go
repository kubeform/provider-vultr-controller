...
// +kubebuilder:rbac:groups=reverse.vultr.kubeform.com,resources=ipv4s,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=reverse.vultr.kubeform.com,resources=ipv4s/status,verbs=get;update;patch
...
func (r *Ipv4Reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &reversev1alpha1.Ipv4{}); err != nil {
			klog.Error(err, "unable to set up auditor", reversev1alpha1.Ipv4{}.APIVersion, reversev1alpha1.Ipv4{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&reversev1alpha1.Ipv4{}).
