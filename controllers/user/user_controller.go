...
// +kubebuilder:rbac:groups=user.vultr.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=user.vultr.kubeform.com,resources=users/status,verbs=get;update;patch
...
func (r *UserReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for User")
			return nil
		}
		...
		resourceList := &userv1alpha1.UserList{}
