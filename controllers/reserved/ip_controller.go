...
// +kubebuilder:rbac:groups=reserved.vultr.kubeform.com,resources=ips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=reserved.vultr.kubeform.com,resources=ips/status,verbs=get;update;patch
...
func (r *IpReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Ip")
...
func (r *IpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &reservedv1alpha1.Ip{}); err != nil {
			klog.Error(err, "unable to set up auditor", reservedv1alpha1.Ip{}.APIVersion, reservedv1alpha1.Ip{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&reservedv1alpha1.Ip{}).
