...
// +kubebuilder:rbac:groups=private.vultr.kubeform.com,resources=networks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=private.vultr.kubeform.com,resources=networks/status,verbs=get;update;patch
...
func (r *NetworkReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &privatev1alpha1.Network{}); err != nil {
			klog.Error(err, "unable to set up auditor", privatev1alpha1.Network{}.APIVersion, privatev1alpha1.Network{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&privatev1alpha1.Network{}).
