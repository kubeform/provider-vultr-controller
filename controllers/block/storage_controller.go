...
// +kubebuilder:rbac:groups=block.vultr.kubeform.com,resources=storages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=block.vultr.kubeform.com,resources=storages/status,verbs=get;update;patch
...
func (r *StorageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &blockv1alpha1.Storage{}); err != nil {
			klog.Error(err, "unable to set up auditor", blockv1alpha1.Storage{}.APIVersion, blockv1alpha1.Storage{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&blockv1alpha1.Storage{}).
