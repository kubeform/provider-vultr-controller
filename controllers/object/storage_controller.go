...
// +kubebuilder:rbac:groups=object.vultr.kubeform.com,resources=storages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=object.vultr.kubeform.com,resources=storages/status,verbs=get;update;patch
...
func (r *StorageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &objectv1alpha1.Storage{}); err != nil {
			klog.Error(err, "unable to set up auditor", objectv1alpha1.Storage{}.APIVersion, objectv1alpha1.Storage{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&objectv1alpha1.Storage{}).
...
func (r *StorageReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Storage")
			return nil
		}
		...
		resourceList := &objectv1alpha1.StorageList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Storage")
			return nil
		}
