...
// +kubebuilder:rbac:groups=ssh.vultr.kubeform.com,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssh.vultr.kubeform.com,resources=keys/status,verbs=get;update;patch
...
func (r *KeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sshv1alpha1.Key{}); err != nil {
			klog.Error(err, "unable to set up auditor", sshv1alpha1.Key{}.APIVersion, sshv1alpha1.Key{}.Kind)
			return err
		}
	}
